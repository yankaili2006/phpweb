...
function MaqHot30(){
	...
	global $fsql,$tsql,$strGuest;
		...
		$needtime=time()-2592000;
		$scl=" iffb='1' and ifopen='1' and pid='0' and dtime>$needtime ";
		...
		$picnum=1;
		$fsql->query("select * from {P}_maq where $scl order by backcount desc limit 0,$shownums");
